...
docs_train, docs_test, y_train, y_test = train_test_split(data, target, test_size=.2, random_state=0)
...
vectorizer = TfidfVectorizer(input='content', encoding='utf-8', analyzer='char', ngram_range=(1, 5))
